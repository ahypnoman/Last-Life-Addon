        ...
        script: (player, args) => {
            ...
            system.run(() => {
                if (args[0] === "help") {
                    ...
                    player.sendMessage("randomlifemode get - gets the status of the randomlife gamerule")
                    player.sendMessage("randomlifemode set <true|false> - sets the randomlife gamrule")
                    ...
                    if (lives > 0 || options.revives) {
                        if (options.players[player.name].lives > 0) {
                            if (player.name !== args[0]) {
                                ...
                                player.sendMessage("§cYou cannot transfer a life to yourself")
                            }
                        } else {
